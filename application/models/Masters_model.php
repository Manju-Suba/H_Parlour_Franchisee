...
class Masters_model extends CI_Model {
    ...
    function get_mp_form_submitted() {
        $user = $this->session->userdata('emp_no');
    ...
    public function get_customer_entered_data($postData,$tb_name){
        ...
        $this->db->select('count(*) as allcount');
        $this->db->from($tb_name);
        $this->db->join('users', 'users.emp_no = user_information.created_by', 'left');
        $this->db->group_start();
        $this->db->where('role !=',"CC");
        $this->db->or_where('user_information.created_by =','Customer');
        $this->db->group_end();
        $this->db->where('user_information.status =','1');
        ...
        $totalRecordwithFilter = $records[0]->allcount;
        ## Fetch records
        $this->db->select("user_information.*,users.role as role");
        $this->db->from($tb_name);
        ...
        if ($searchQuery != '') 
          ...
          $this->db->group_end();
          $this->db->where('user_information.status =','1');
          $this->db->order_by('user_information.id', 'desc');  # or desc
        $this->db->limit($rowperpage, $start);
        $records = $this->db->get()->result();
    ...
    public function get_location_table_rep($postData,$tb_name){
        ...
        {	
            ...
            $action = '
            <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" title="Place Review"  onclick="edit_location('."'".$record->id."'".')">Place Review</button>';
    ...
    public function get_completed_location($postData,$tb_name , $col,$val ){
        ...
        {	
            ...
            $img= '<button class="btn btn-warning" data-toggle="modal" title="View" data-target="#myModalview"   onclick="get_image('."'".$record->id."'".')">View</button>';
            $action = '<button class="btn btn-success" title="Action" data-toggle="modal" data-target="#myModal" onclick="get_id('."'".$record->id."'".')"><i class="fa fa-hand-paper-o"></i></button>';
            $view = '<button class="btn btn-primary" data-toggle="modal" title="View" data-target="#myModal" onclick="get_id('."'".$record->id."'".')"><i class="fa fa-eye"></i></button>';
    ...
    public function get__approved_location($postData,$tb_name , $col,$val ,$array){
        ...
        {	
            ...
            $action = '<button class="btn btn-success" data-toggle="modal" data-target="#myModal" title="Action" onclick="get_id('."'".$record->id."'".')"><i class="fa fa-hand-paper-o"></i></button>';
    ...
    public function total_count_bd($array,$table) {
