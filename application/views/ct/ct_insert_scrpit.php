                        ...
                        <form class="" action="<?php echo base_url('index.php/ct/update_user_information'); ?>" enctype="multipart/form-data" id="" data-parsley-validate method="post" autocomplete="off">
                            <div id="tabs-container">
                                <ul class="tabs-menu tab example">
                                    <li class="tab-1 tablinks active" id="tab1"><a href="#level_of_interest">Level of Interest</a>
                                    </li>
                                    <li class="tab-2 tablinks" id="tab2"><a href="#passion">Passion</a>
                                    </li>
                                    <li class="tab-3 tablinks" id="tab3"><a href="#after_taking">After Taking</a>
                                    </li>
                                    <li class="tab-4 tablinks" id="tab4"><a href="#aspects">Aspects</a>
                                    </li>
                                    <li class="tab-5 tablinks" id="tab5"><a href="#business_development">Business Development</a>
                                    </li>
                                    <li class="tab-6 tablinks" id="tab6"><a href="#manpower_handling">Manpower Handling</a>
                                    </li>
                                    <li class="tab-6 tablinks" id="tab7"><a href="#scenarios">Scenarios</a>
                                    </li>
                                </ul>
                            </div>
                            <div id="level_of_interest" class="tabcontent" >
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <div id="select_sty">
                                                <select id='attendee_p' name="attendee_p[]" multiple class="form-control required">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <div id="select_sty">
                                                <select name="attendee_v[]" id="attendee_v" multiple class="form-control required">
                                                    <option value="Emp001">Emp001</option>
                                                    <option value="Emp002">Emp002</option>
                                                    <option value="Emp003">Emp003</option>
                                                    <option value="Emp004">Emp004</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="fileupload" multiple="multiple" name="image_name[]" class="form-control required" value="">
                                ...
                                <br>
                                <button type="button" class="btn btn-info float-right ml-2 mr-2 tablinks next" id="next1" data-next="#passion" >Next</button>
                            </div>
                            ...
                            <div id="passion" class="tabcontent" style="display:none;">
                                ...
                                <div id="business">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <textarea type="text" name="passion_g" id="passion_g" rows="2" class="form-control required" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="btn-sty">
                                    ...
                                    <button type="button" class="btn btn-info tablinks next" id="next2" data-next="#passion">Next</button>
                                </div>
                            </div>
