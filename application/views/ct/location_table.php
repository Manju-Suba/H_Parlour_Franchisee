                            ...
                            <div class="modal-body">
                                <!-- <form role="form" id="edit_location_review_form" action="javascript:void(0)"  class="ajax-form" method="POST" > -->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-3">State <span class="float-right">:</span></div>
                                                <div class="col-md-9" id="state"></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">City  <span class="float-right">:</span></div>
                                                <div class="col-md-9" id="city"></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">Town <span class="float-right">:</span></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-4">Shop Name <span class="float-right">:</span></div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  id="morning" name="morning" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-4" id="pri" hidden="true">
                                            <div class="form-group">
                                                <label for="">Upload Image </label>
                                                <input type="file" name="place_review_image" id="place_review_image" class="form-control">
