...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="updated_tbl">
                                        <thead>
                                            <tr>
                                            	<th>S.NO</th>
                                            	<th>Action</th>
    ...
    ***********************************-->
    ...
    <!-- added new --> 
    <script src="<?php echo asset_url();?>new_add/js/ct_updated_form.js"></script> 
    ...
    <script>
	    ...
	    $(document).ready(function () { 
            var  page="ct_updated_form";

            if(page=="ct_updated_form"){
                $(".ct_updated_form").addClass("active");
            }
