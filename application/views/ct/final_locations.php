...
<html lang="en">
    ...
    <body>
                                        ...
                                        <!-- <a class="btn btn-primary text-white float-right" href="add_location">Add Location</a> -->
                                            ...
                                            <section>
                                                <div class="table-responsive" >
                                                    <table id="final_locations" class="table table-striped table-bordered zero-configuration">
                                                        <thead>
                                                            <tr>
                                                                <th>S.No</th>
                                                                <th>State</th>
                                                                ...
                                                                <th style="width:16%;">Place Review</th>
                                                                <th>Reviewed Date</th>
                                                                <th>Approved Date</th>
                                                                <th>Image</th>
                                                            </tr>
        ...
        ***********************************--> 
        ...
        <script src="<?php echo asset_url();?>new_add/js/final_locations_ct.js"></script>
