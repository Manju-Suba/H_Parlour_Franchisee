                                            	...
                                            	<td>
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu" style="min-width:0;">
                                                            ...
                                                            <li><a href="#" style="width:70%;" class="dropdown-item pl-0" data-toggle="modal" data-target="#additionaview_<?php echo $val['id'];?>"><i class="fa fa-eye pl-2" aria-hidden="true"></i>&nbsp;&nbsp;Details</a></li>
                                                        </ul>
                                                    </div> 
                                                </td>
                                                ...
                                                <td style="font-size: 13px;">
                                                    ...
                                                    <div class="row">&nbsp;&nbsp;<span>FCC :</span>
                                                        ...
                                                        if($val['distributor_code']!=""){
                                                            ?><b class="text-success">Approved</b><?php
                                                        }else if($val['ct_post_doc_upload']=="uploaded" && $val['ct_post_doc_upload']=="uploaded" ){
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="col-md-12" style="text-align:center;">
                                                            <a href="<?php echo base_url('index.php/ct/ct_insertion_form/'.$val['id']); ?>" class="btn btn-success">Add More Details </a>
                                                            <!-- <button type="button" class="btn btn-primary" onclick="add_more_info(<?php echo $val['id'];?>)">Add More Details</button> -->
                                                        </div>
