...
<body>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <form class="step-form-horizontal" id="filter_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/ct/post_upload_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1">
                                                </div>  
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="post_upload_form_list">
                                            <thead>
                                                <tr> 
                                                    <th>S.NO</th>
                                                    <th>Action</th>
    ...
    ***********************************--> 
    ...
    <script src="<?php echo asset_url();?>new_add/js/post_upload_form.js"></script>
    ...
    <script> 
		...
		var  page="post_upload_form";

		if(page=="post_upload_form"){
			$(".post_upload_form").addClass("active");
		}
