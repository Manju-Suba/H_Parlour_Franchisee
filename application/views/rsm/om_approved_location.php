...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="step-form-horizontal p-4" action="javascript:void(0)" enctype="multipart/form-data" id=""   data-parsley-validate method="post" autocomplete="off"> 
                                        <div> 
                                            <h4 class="ml-4">Operation Manager Approved Locations</h4>
                                            <section>
                                                <div class="table-responsive" >
                                                    <table id="om_app_location" class="table table-striped table-bordered zero-configuration">
                                                        <thead>
                                                            <tr>
                                                                <th>S.No</th> 
                                                                <th>State</th>
        ...
        ***********************************--> 
        ...
        <script src="<?php echo asset_url();?>new_add/js/completed_location_rsm.js"></script>
        ...
        <script>
            ...
            $(document).ready(function () {
                var  page="om_approved_location";

                if(page=="om_approved_location"){
                    $(".om_approved_location").addClass("active");
                }
            }); 
	    </script>
