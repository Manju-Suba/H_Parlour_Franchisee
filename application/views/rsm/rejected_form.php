                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                    <form class="step-form-horizontal" id="basic-form" action="<?php echo base_url('index.php/rsm/rejected_form'); ?>" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-1">
                                                <a href="<?php echo base_url(); ?>index.php/rsm/rejected_form" class="btn btn-success mt-4">Reset</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
