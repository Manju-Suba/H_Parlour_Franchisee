                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                    <form class="step-form-horizontal" action="<?php echo base_url('index.php/rsm/approved_form'); ?>" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                        <div class="form-row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="bdm" id="bdm" class="form-control nice_select">
                                                            ...
                                                            <?php foreach($bdm_emp_no as $val) { ?>
                                                                <option value="<?php echo $val['BDM_emp_no']; ?>" <?php echo ($val['BDM_emp_no'] == $bdm ? 'selected' : ''); ?>><?php echo $val['BDM_name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group col-md-1">
                                                <a href="<?php echo base_url(); ?>index.php/rsm/approved_form" class="btn btn-success mt-4">Reset</a>
                                            </div>
                                        </div>
                                    </form> 
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td style="font-size: 14px;"> 
                                                    ...
                                                    <br>
                                                    <div class="row">&nbsp;&nbsp;<span class="p-1">CT Score &nbsp;&nbsp;:</span>
                                                        <?php 
                                                            if( ($val['ct_score'] >= "80") && ($val['ct_score'] <= "100") ){
                                                                ?><b class="text-white bg-success p-1"><?php echo $val['ct_score']; ?></b><?php
                                                            } 
                                                            elseif( ($val['ct_score'] >= "50") && ($val['ct_score'] <"80")){
                                                                ?><b class="text-white bg-warning p-1"><?php echo $val['ct_score']; ?></b><?php
                                                            }else{
                                                                ?><b class="text-white bg-danger p-1"><?php echo $val['ct_score']; ?></b><?php
                                                            }
                                                        ?>
                                                    </div>
                                                </td>
                                                ...
                                                ?>
                                                <td style="font-size: 13px;"><span>SH :</span>
                                                    <?php 
                                                    if($val['sh_approval']=="Approved"){
                                                        ?><b class="text-success">Approved</b><?php
                                                    }else if($val['sh_approval']=="Rejected"){
                                                    ...
                                                    if($val['distributor_code']!=""){
                                                        ?><b class="text-success">Completed</b><?php
                                                    }else if($val['ct_post_doc_upload']=="uploaded" && $val['ct_pre_doc_upload']=="uploaded" ){
                                                        ?><b class="text-warning">Approved</b><?php
                                                    }  
                                                    else{
                                                        ?><b class="text-warning">Pending</b><?php
                                                    } 
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="row" style="padding:12px 0;">
                                                            <div class="col-4">Name: <?php echo $val['name']; ?></div>
                                                            <div class="col-4">Mobile: <?php echo $val['mobile']; ?></div>
                                                            <div class="col-4">Educational Qualification: <?php echo $val['education']; ?></div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#fff;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['occupation']; ?></div>
                                                            <div class="col-2"><?php echo $val['occup_remark']; ?></div>
                                                        </div>
                                                        <div class="row" style="padding:8px 0; background:#f3f3f3;">
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#f3f3f3;">
                                                            ...
                                                            <div class="col-3">Before 6 months :<?php echo $val['expect_income']; ?></div>
                                                            <div class="col-2"><?php echo $val['expect_income_remark']; ?></div>
                                                            <div class="col-7"></div>
                                                            <div class="col-3">After 6 months :<?php echo $val['expect_income1']; ?></div>
                                                            <div class="col-2"><?php echo $val['expect_income_remark1']; ?></div>
                                                        </div>
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#fff;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['6c']; ?> months</div>
                                                            <div class="col-2">
                                                                <?php 
                                                                if($val['6c'] == "0"){
                                                                    echo '10';
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#f3f3f3;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['6d']; ?></div>
                                                            <div class="col-2">
                                                                <?php 
                                                                if($val['6d'] == "Yes"){
                                                                    echo '10';
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#fff;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['6e']; ?></div>
                                                            <div class="col-2">
                                                                <?php 
                                                                    if($val['6e'] <= "30") {
                                                                        echo '10';
                                                                    }elseif( $val['6e'] > "30" && $val['6e'] < "50"){
                                                                        echo '5';
                                                                    }else{
                                                                        echo '0';
                                                                    }
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#f3f3f3;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['7c']; ?></div>
                                                            <div class="col-2">
                                                                <?php 
                                                                if($val['7c'] >= "500000"){
                                                                    echo '20';
                                                                }elseif( $val['7c'] > "299999" && $val['7c'] <"500000"){
                                                                    echo '10';
                                                                }else{
                                                                    echo '0';
                                                                }
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#fff;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['8a']; ?></div>
                                                            <div class="col-2">
                                                                <?php 
                                                                    if($val['8a'] == "Own Fund"){
                                                                        echo '10';
                                                                    }elseif($val['8aa'] == "Partial Loan"){
                                                                        echo '5';
                                                                    }else{
                                                                        echo '0';
                                                                    }
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#f3f3f3;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['11aa']; ?></div>
                                                            <div class="col-2">
                                                                <?php 
                                                                    if($val['11aa'] == "Yes"){
                                                                        echo '20';
                                                        ...
                                                        <div class="row" style="padding:8px 0; background:#fff;">
                                                            ...
                                                            <div class="col-3"><?php echo $val['11bb']; ?></div>
                                                            <div class="col-2">
                                                                <?php
                                                                    if($val['11bb'] == "Yes"){
                                                                        echo '20';
                                                        ...
                                                        <?php if( ($val['ct_score'] <= "100") && ($val['ct_score'] >= "80") ){ ?>
                                                            <div class="row" style="padding:8px 0; background:#e1f3da; font-weight:bold; font-size:14px;">
                                                                <div class="col-7">CT Total</div>
                                                                <div class="col-3"></div>
                                                                <div class="col-2">
                                                                    <b class="text-white bg-success p-1"><?php echo $val['ct_score']; ?></b>
                                                                </div>
                                                            </div>
                                                        <?php } elseif( ($val['ct_score'] >= "50") && ($val['ct_score'] < "80") ){?>
                                                            <div class="row" style="padding:8px 0; background:#f7d8b261; font-weight:bold; font-size:14px;">
                                                                <div class="col-7">CT Total</div>
                                                                <div class="col-3"></div>
                                                                <div class="col-2">
                                                                    <b class="text-white bg-warning p-1"><?php echo $val['ct_score']; ?></b>
                                                                </div>
                                                            </div>
                                                        <?php } else{?>
                                                            <div class="row" style="padding:8px 0; background:#eb6c5840; font-weight:bold; font-size:14px;">
                                                                ...
                                                                <div class="col-3"></div>
                                                                <div class="col-2">
                                                                    <b class="text-white bg-danger p-1"><?php echo $val['ct_score']; ?></b>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <hr>
