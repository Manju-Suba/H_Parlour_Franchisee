                            ...
                            <div class="card-body">
                                <div class="col-12">
                                        ...
                                        <form class="step-form-horizontal" id="filter_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/sh/ct_uploaded_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1"> 
                                                </div> 
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="doc_approved_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th> 
                                                    <th>Details</th>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Choosen Training Team</h5>
                                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <form id="pop_tt_choosen" action="javascript:void(0);" enctype="multipart/form-data" method="post" autocomplete="off">
                                                <input type="hidden" name="id" id="id" class="form-control" value="">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label>Available Trainee</label>
                                                        
                                                        <select id="tt_choosen" name="tt_choosen" class="form-control nice_select" required>
                                                            <option value="">choose trainee</option>
                                                            <option value="1014548"> ARUNKUMAR</option>
                                                            <option value="1014833"> SEMON</option>
                                                        </select>
                                                    </div>
                                                </div>
    ...
    ***********************************-->
    ...
    <script>
	    ...
	    $(document).ready(function () {
            var  page="ct_uploaded_form";

            if(page=="ct_uploaded_form"){
                $(".ct_uploaded_form").addClass("active");
            }
