                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal" id="upload_filter_form" action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <a href="<?php echo base_url(); ?>index.php/sh/mt_uploaded_form" class="btn btn-success mt-4">Reset</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="maintanance_team_uploaded_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
    ...
    ***********************************-->
    ...
    <script>
	    ...
	    $(document).ready(function () {
            var  page="mt_uploaded_form";

            if(page=="mt_uploaded_form"){
                $(".mt_uploaded_form").addClass("active");
            }
