...
<head>
    ...
    <style>
        ...
        #danger.btn-danger:focus, #danger.btn-danger:hover {
            background: #ff2b2b;
            color: #fff;
            border-color: #ff2b2b;
        }
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" id="edit_location_form" action="javascript:void(0)" class="ajax-form" method="POST">
                                <div class="row">
                                    <div class="col-lg-4">
                        ...
                        <div class="modal-footer">
                            <span class="text-success font-weight-bold" id="update"></span>&nbsp;
                            <button class="btn btn-success" id="update_location">Update</button>
                            <button type="button" class="btn btn-danger" id="danger" data-dismiss="modal">Close</button>
                        </div>
                        </form> 
                    </div>
                </div>
