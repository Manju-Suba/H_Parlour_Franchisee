                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="step-form-horizontal p-4" action="javascript:void(0)" enctype="multipart/form-data" id=""   data-parsley-validate method="post" autocomplete="off"> 
                                        <div>
                                            <h4 >Nethaji Approved Locations</h4>
                                            <section>
                                                <div class="table-responsive" >
                                                    <table id="final_location" class="table table-striped table-bordered zero-configuration">
                                                        <thead>
                                                            <tr> 
                                                                <th>S.No</th>
                                                                <th>State</th>
                            ...
                            <form id="upload_doc_form" action="javascript:void(0);" enctype="multipart/form-data" method="post" autocomplete="off">	
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">MOM</label>
                                        <div class="ml-4" id="doc_1_img"></div>
                                        <input type="file" name="doc_1" id="doc_1" accept="image/*" onchange="ValidateSingleInput(this);" class="form-control" value="0">
                                        
                                    </div>
                                </div> 
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Upload Doc 2</label>
                                        <div class="ml-4" id="doc_2_img"></div>
                                        <input type="file" name="doc_2" id="doc_2" accept="image/*" onchange="ValidateSingleInput(this);" class="form-control" value="0">
                                        
                                    </div>
                                </div> 
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Upload Doc 3</label>
                                        <div class="ml-4" id="doc_3_img"></div>
                                        <input type="file" name="doc_3" id="doc_3" accept="image/*" onchange="ValidateSingleInput(this);" class="form-control" value="0">
