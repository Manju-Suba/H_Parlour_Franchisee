...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal" id="filter_rejected_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/sa/sa_rejected_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1">
                                                </div> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration ml-1" id="rejected_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
                                                                ...
                                                                <section>
                                                                    ...
                                                                    <div class="form_hid_action_doc" style="display:none;"> 
                                                                        <div class="form-group">
                                                                            <label class="col-md-3 control-label" for="Department">Franchisee Code</label>
                                                                            <div class="col-md-12">
                        ...
                        <!-- <!?php include('application/views/include/sh_approved_form_ct_log_pop.php'); ?>  -->
    ...
    ***********************************-->
    ...
    <script src="<?php echo asset_url();?>new_add/js/sa_code_pending.js"></script>
    ...
    <script>
		...
		var  page="sales_admin_rejected";

		if(page=="sales_admin_rejected"){
			$(".sales_admin_rejected").addClass("active");
		}
