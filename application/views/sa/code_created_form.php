...
<body>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <form class="step-form-horizontal" id="filter_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-1 my-4">
                                                <a href="<?php echo base_url(); ?>index.php/sa/code_created_form" class="btn btn-success">Reset</a>
                                            </div>
                                            <div class="form-group col-md-1">
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="created_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <form action="javascript:void(0)" class=""   enctype="multipart/form-data" id="distributor_code_form" autocomplete="off"> 
                                                                <section>
                                                                    <button type="button" name="approval" id="app_btn" class="btn mb-1 ml-3 btn-success">Update Franchise Code</button>
                                                                    <br>
                                                                    <br>
                                                                    <div class="form_hid_action_doc"> 
    ...
    ***********************************-->
    ...
    <script src="<?php echo asset_url();?>new_add/js/sa_code_created.js"></script>
    ...
    <script>
		...
		var  page="code_created_form";

		if(page=="code_created_form"){
			$(".code_created_form").addClass("active");
		}
