                            ...
                            <div class="card-body">
                                <div class="col-12">
                                        ...
                                        <form class="step-form-horizontal" id="filter_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/sa/code_pending_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1">
                                                </div> 
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration ml-1" id="pending_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
