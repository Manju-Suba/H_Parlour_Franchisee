                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal" id="rsm_filter_form" action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <a href="<?php echo base_url(); ?>index.php/cidhaya/entered_form" class="btn btn-success mt-4">Reset</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
