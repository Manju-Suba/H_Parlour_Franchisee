...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            table.dataTable thead>tr>th.sorting_asc#remar, table.dataTable thead>tr>th.sorting_desc#remar, table.dataTable thead>tr>th.sorting#remar, table.dataTable thead>tr>td.sorting_asc#remar, table.dataTable thead>tr>td.sorting_desc#remar, table.dataTable thead>tr>td.sorting#remar {
                padding-right: 75px;
            }
                            ...
                            <div class="card"> 
                                <div class="card-body">
                                    <form class="step-form-horizontal p-4" action="javascript:void(0)" enctype="multipart/form-data" id=""   data-parsley-validate method="post" autocomplete="off"> 
                                        <div>
                                            <h4 >Final Locations</h4>
                                            <section>
                                                <div class="table-responsive" >
                                                    <table id="approved_location" class="table table-striped table-bordered zero-configuration">
                                                        <thead>
                                                            <tr>
                                                                <th>S.No</th>
                                                                <th>State</th>
