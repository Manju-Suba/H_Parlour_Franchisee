...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="step-form-horizontal p-4" action="javascript:void(0)" enctype="multipart/form-data" id=""   data-parsley-validate method="post" autocomplete="off"> 
                                        <div>
                                            <h4 >Idhaya Approved Locations</h4>
                                            <section>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <form id="pop_rej_ap_form" action="javascript:void(0);" enctype="multipart/form-data" method="post" autocomplete="off">	
                                ...
                                <button type="button" name="reject" id="rej_btn" class="btn mb-1 ml-2 btn-danger">Hold (Future Prospects)</button>
                                
                                <div class="form_hid_action_doc" style="display:none;"> </div>
                                <div class="form_hid_action mt-4" style="display:none;"> 
        ...
        ***********************************--> 
        ...
        <script src="<?php echo asset_url();?>new_add/js/completed_location_idhaya.js"></script>
