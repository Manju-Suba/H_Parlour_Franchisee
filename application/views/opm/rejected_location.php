...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="step-form-horizontal p-4" action="javascript:void(0)" enctype="multipart/form-data" id=""   data-parsley-validate method="post" autocomplete="off"> 
                                        <div>
                                            <h4 >Rejected Locations</h4>
                                            <section>
                                                <div class="table-responsive" >
                                                    <table id="rejected_location" class="table table-striped table-bordered zero-configuration">
                                                        <thead>
                                                            <tr>
                                                                <th>S.No</th> 
                                                                <th>State</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="pop_rej_ap_form" action="javascript:void(0);" enctype="multipart/form-data" method="post" autocomplete="off">	
                                    ...
                                    <button type="button" name="approval" id="app_btn" class="btn mb-1 ml-3 btn-success">Approval For This Location</button>
                                    ...
                                    <div class="form_hid_action_doc" style="display:none;"> 
                                        <div class="form-group">
                                            ...
                                            <p id="doc_req" style="display:none;"></p>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="remark">Move to</label>
                                            <div class="col-md-12">
                                                <select id="rsm_choosen" name="rsm_choosen" class="form-control" >
                                                    <option value="" selected disabled>Select..</option>
                                                    <option value="1014805">ASLAM</option>
                                                    <option value="1013930">KARTHIKEYAN</option>
                                                    <option value="1011773">PERUMAL</option>
                                                </select>
                                            </div>
                                            <p id="move_to_req" style="display:none;"></p>
                                        </div>
                                    </div>
        ...
        ***********************************--> 
        ...
        <script src="<?php echo asset_url();?>new_add/js/completed_location_opm.js"></script>
        ...
        <script>
            ...
            $(document).ready(function () {
                var  page="rejected_location";

                if(page=="rejected_location"){
                    $(".rejected_location").addClass("active");
                }
            }); 
	    </script>
