...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal" id="opm_filter_form" action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <a href="<?php echo base_url(); ?>index.php/opm/entered_form" class="btn btn-success mt-4">Reset</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="entered_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
                        ...
                        <div class="modal-dialog" role="document"> 
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="opm_rej_ap_form" action="javascript:void(0);" enctype="multipart/form-data" method="post" autocomplete="off">	
        ...
        ***********************************--> 
        ...
        <!-- <script src="<?php echo asset_url();?>new_add/js/total_count_opm.js"></script> -->
        <script src="<?php echo asset_url();?>new_add/js/get_opm_all_form.js"></script>
        ...
        <script>
            ...
            $(document).ready(function () {
                var page = "rsm_entered_form";

                if (page == "rsm_entered_form") {
                    $(".rsm_entered_form").addClass("active");
                }
