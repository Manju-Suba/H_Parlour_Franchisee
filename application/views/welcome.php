                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal"  action="<?php echo base_url('index.php/sh/entered_form'); ?>" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="rsm" id="rsm" class="form-control nice_select">
                                                                ...
                                                                <?php foreach($rsm_name as $val) { ?>
                                                                    <option value="<?php echo $val['RSM_name']; ?>" <?php echo ($val['RSM_name'] == $rsm ? 'selected' : ''); ?>><?php echo $val['RSM_name']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="bdm" id="bdm" class="form-control nice_select" >
                                                                ...
                                                                <?php foreach($bdm_name as $val) { ?>
                                                                    <option value="<?php echo $val['BDM_name']; ?>" <?php echo ($val['BDM_name'] == $bdm ? 'selected' : ''); ?>><?php echo $val['BDM_name']; ?></option>
                                                                <?php } ?>
                                                ...
                                                <div class="form-group col-md-1">
                                                    <button type="submit" class="btn btn-dark mt-4 ml-4">Filter</button>
                                                </div>
                                                <div class="form-group col-md-1">
                                                    <a href="<?php echo base_url(); ?>index.php/sh/entered_form" class="btn btn-success mt-4">Reset</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="rsmi_entered_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($user_information as $k => $val) { ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td><button title="Action" type="button" class="btn btn-success" onclick="approve_action('<?php echo $val['id'];?>');"><i class="fa fa-hand-paper-o"></i></button></td>
                                                    </tr>
