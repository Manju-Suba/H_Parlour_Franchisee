            ...
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-md-12"> 
                        <div class="card">
                            <div class="card-body">
                                <form  action="<?php echo base_url('index.php/mp/user_info'); ?>" data-parsley-validate method="post" autocomplete="off" enctype="multipart/form-data"> 
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="monthly_income" id="monthly_income" class="form-control" placeholder="₹"  required>
                                                </div>
                                            </div> 
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="">Family's total Monthly Income <span style="color:red;">*</span></label>
                                                    <input type="number" name="family_income" id="family_income" class="form-control" placeholder="₹"  required>
                                                </div>
                                            </div> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4"> 
                                                <div class="form-group">
                                                    <label for="">Referred Person</label>
...
/////////////////
		...
		function getZipList(townID) {
            ...
            $.ajax({
				url: BASE_URL + 'common/get_population',
				type: 'post',
				data: {townID: townID},
				dataType: 'json',
				success: function (json) {
