...
<body>
                                        ...
                                        <form class="step-form-horizontal" id="filter_rejected_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/common/sa_rejected_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1">
                                                </div> 
    ...
    ***********************************-->
    ...
    <script src="<?php echo asset_url();?>new_add/js/sa_rejected_form.js"></script>
    ...
    <script src="<?php echo asset_url();?>new_add/js/datepicker.js"></script>
