            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding-top:0; max-height: calc(100vh - 210px);overflow-y: auto;">
                    <div class="row" style="padding:12px 0;">
                        <div class="col-3" >Name: <p id="pop_name"></p></div>
                        <div class="col-3" >Mobile: <p id="pop_mobile"></p></div>
                        <div class="col-3" >Educational Qualification : <p id="pop_education"></p></div>
                        <div class="col-3" >
                            <button type="button" class="btn btn-primary md-5" onclick="show_doc()">Doc View</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row ml-1" style="padding:12px 0; background:#F3F1FA; font-weight:bold; font-size:14px;" id="show_doc">
                        <div class="row">
                            <div class="col-4" >
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <p>9)  If your friend having shop in another area asking you to supply milk & milk products .what will you do?</p>
