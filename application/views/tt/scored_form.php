...
<body>
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    ...
                                    <div class="basic-form" style="padding:1.88rem 1.81rem 0 1.81rem">
                                        <form class="step-form-horizontal" id="scored_filter_form"  action="javascript:void(0)" enctype="multipart/form-data"  method="post" data-parsley-validate autocomplete="off">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1 my-4">
                                                    <a href="<?php echo base_url(); ?>index.php/tt/scored_form" class="btn btn-success">Reset</a>
                                                </div>
                                                <div class="form-group col-md-1">
                                                </div> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration ml-1" id="scored_form_list">
                                            <thead>
                                                <tr>
                                                    <th>S.NO</th>
                                                    <th>Details</th>
    ...
    ***********************************-->
    ...
    <script src="<?php echo asset_url();?>new_add/js/tt_doc_approved.js"></script>
    ...
    <script>
		...
		var  page="code_pending_form";

		if(page=="code_pending_form"){
			$(".code_pending_form").addClass("active");
		}
