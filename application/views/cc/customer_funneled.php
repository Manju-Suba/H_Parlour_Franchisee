...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="customer_funneled_tbl">
                                        <thead>
                                            <tr>
                                            	<th>S.NO</th> 
                                                <th>Name</th>
    ...
    ***********************************--> 
    ...
    <!-- added new --> 
    <script src="<?php echo asset_url();?>new_add/js/cc_cus_funneled_form.js"></script> 
    ...
    <script>
        ...
        $(document).ready(function () {
            var  page="customer_funneled_form";

            if(page=="customer_funneled_form"){
                $(".customer_funneled_form").addClass("active");
            }
