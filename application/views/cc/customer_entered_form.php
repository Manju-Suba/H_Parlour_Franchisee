...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="customer_entered_tbl">
                                        <thead>
                                            <tr>
                                            	<th>S.NO</th>
                                            	<th>Action</th>
                        ...
                        <?php include('application/views/include/customer_detail_pop.php'); ?>
                    </div>  
                </div> 
            </div>
            <!-- #/ container -->
    ...
    ***********************************--> 
    ...
    <!-- added new --> 
    <script src="<?php echo asset_url();?>new_add/js/cc_cus_entered_form.js"></script> 
    ...
    <script>
	 ...
	 $(document).ready(function () {
		var  page="customer_entered_form";

		if(page=="customer_entered_form"){
			$(".customer_entered_form").addClass("active");
		}
