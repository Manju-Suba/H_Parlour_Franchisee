                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu" style="min-width:0;">
                                                            ...
                                                            <li><a href="#" style="width:70%;" class="dropdown-item pl-0" data-toggle="modal" data-target="#exampleModalLong<?php echo $val['id'];?>"><i class="fa fa-eye pl-2" aria-hidden="true"></i>&nbsp;&nbsp;Details</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="font-size: 13px;">
                                                    ...
                                                    <br>
                                                    <div class="row">&nbsp;&nbsp;<span>FCC :&nbsp;</span>
                                                        <?php 
                                                        if($val['ct_post_doc_upload']=="uploaded" && $val['ct_post_doc_upload']=="uploaded" && $val['distributor_code']=="" ){
                                                            ?><b class="text-success">Approved</b><?php
                                                        }else if($val['distributor_code']!="" && $val['ct_post_doc_upload']=="uploaded" && $val['ct_post_doc_upload']=="uploaded"){
