...
function get_funneled_form_list(){
    ...
    var ct = $('#customer_funneled_tbl').DataTable({
        // 'dom': 'Bfrtip',
        ...
        'ajax': {
            'url': BASE_URL + 'cc/get_customer_funnel_data',
            'data': function(data) {
...
function edit_business_pop(id){
    ...
    $.ajax({ 
        ...
        success: function (data) {
            ...
            sperson_age = data["row"][0]['sperson_age'];
            if(sperson_age == 0){
                $("#sperson_age").val();
            }else{
            ...
            income1 = data["row"][0]['expect_income'];
            if(income1 == 0){
                $("#expect_income").val();
            }else{
            ...
            income2 = data["row"][0]['expect_income1'];
            if(income2 == 0){
                $("#expect_income1").val();
            }else{
            ...
            // if($('#edit_distributor_pop').modal('show')){
            //     $('#steps-uid-0-t-0').html('<span class="current-info audible">current step: </span><span class="number">1.</span>Details of Individuals');
            //     $('#steps-uid-0-t-1').html('Frc');
                
            //     $('#steps-uid-0-h-0').addClass('current');
            //     $('#steps-uid-0-h-1').removeClass('current');
            //     $('#steps-uid-0-p-0').addClass('current');
            //     $('#steps-uid-0-p-0').css({'display':'block'});
            //     $('#steps-uid-0-p-1').removeClass('current');
            //     $('#steps-uid-0-p-1').css({'dispaly':'none'});
            // }
