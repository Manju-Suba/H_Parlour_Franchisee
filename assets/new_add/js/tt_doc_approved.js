...
$("#scored_filter_form").submit(function(){
    get_scored_datas();
})
...
function get_approved_datas(){
    var ct = $('#doc_approved_list').DataTable({
        ...
        'ajax': { 
            'url': BASE_URL + 'tt/doc_approved_form', 
            'data': function(data) {  
...
$("#pop_tt_score_form").submit(function(e){
...
function total_count_tt(){
    $.ajax({
        ...
        success: function(data){ 
            ...
            $('#scored_form_count').html(data.scored_form_count);
...
function get_scored_datas(){
    var ct = $('#scored_form_list').DataTable({
        ...
        'ajax': { 
            'url': BASE_URL + 'tt/scored_form_list', 
            'data': function(data) { 
                data.from_date = $('#from_date').val();
                data.to_date = $('#to_date').val();
            }
